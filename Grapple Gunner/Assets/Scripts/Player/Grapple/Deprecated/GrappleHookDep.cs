...
public class GrappleHookDep : MonoBehaviour
{
    ...
    private GrappleGunDep grappleGun;
    ...
    void OnCollisionEnter(Collision other)
    {
        ...
        if (other.gameObject.tag == "Hookable")
        {
            ...
            GrapplePointDep gp = other.gameObject.GetComponent<GrapplePointDep>();
    ...
    public void SetProperties(float speed, GrappleGunDep gun, Transform dummyTransform, float interpolateValue)
    {
        travelSpeed = speed;
        grappleGun = gun;
